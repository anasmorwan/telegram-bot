...
JUMUAH_MORNING = [
    ...
    " إنّ صلاتكم معروضةٌ عليه.. أكثر من الصلاة على النبي ﷺ واجعل لسانك رطباً بذكراها. اكتب: تم 🤍",
...
JUMUAH_EVENING = [
    "أين حظك من الصلاة على النبي اليوم؟ اختم جمعتك بالوفاء لمن بكى شوقاً لرؤيتنا. اكتب: صلّيت 🤍",
...
JUMUAH_REMINDERS = [
    ...
    " الكهف نورٌ.. سنذكرك بعد ساعة من الآن، كن من أهل القرآن وأخبرنا: أنهيت 🤍",
...
EID_FITR_MESSAGES = [
    {
        "text": "🎉 | طوال شهر كامل كنت تضبط منبهك على السحور، وتحسب الساعات للمغرب، وتجاهد نفسك لتقف في التراويح.. وفجأة، انتهى كل شيء وعاد النهار نهاراً كما كان. العيد ليس مجرد يوم للملابس الجديدة والحلوى، بل هو محطة وقوف لتقول لنفسك: 'أنا استطعت أن أغير روتيني شهراً كاملاً لأجل الله، إذن أنا قادر على الاستمرار'. لا تترك مصحفك ولا تقطع صلاتك التي تعودت عليها. عيدكم مبارك وتقبل الله طاعاتكم.",
        "image_search": "https://www.google.com/search?tbm=isch&q=أجواء+عيد+الفطر+بهجة+عفوية+أطفال+مسلمين"
    },
    {
        "text": "🕌 | تسمع تكبيرات العيد تصدح من مآذن المساجد، وربما تشعر ببعض غصة أو تقصير لأن رمضان مرّ ولم تفعل فيه كل ما تمنيت. يا أخي، لا يدخلنّ الشيطان إلى قلبك ليفسد فرحتك بيوم الجائزة. الله غفور شكور، يقبل القليل ويعفو عن الكثير. اخرج لصلاة العيد، كبّر مع الناس بقلب راجٍ، واجعل 'الله أكبر' هذه المرة إعلاناً بأنك تبدأ صفحة جديدة مع ربك من اليوم.",
        "image_search": "https://www.google.com/search?tbm=isch&q=مآذن+مسجد+وقت+الشروق+تكبيرات+العيد"
    }
]


EID_ADHA_MESSAGES = [
    "🐑 | تمشي في الشارع فترى الناس يركضون؛ هذا يشتري أضحية، وهذا يجهز ملابس العيد، والكل مستعجل. وسط هذه الزحمة، هل تذكرت شخصاً بينك وبينه خصومة؟ العيد لا ينتهي بمجرد مظاهر الفرح، وإنما العبرة بتطهير القلوب ابتغاء مرضات الله. بادر أنت بالسلام اليوم، واجعل هذه الخطوة قرباناً تتقرب به إلى الله في هذا الصباح المبارك. تقبل الله طاعاتكم وأسعد أيامكم.",

    "📿 | نردد 'الله أكبر' في العيد كعادة اعتراها التكرار دون تدبر. توقف قليلاً واستشعر هذه الكلمة؛ الله أكبر من همّ رزقك، وأكبر من مرضك، وأكبر من كل كرب يمر بك في هذه الدنيا. إذا كان الملك سبحانه أكبر من كل شيء، فلِمَ الخوف والاضطراب؟ املأ بيتك بذكر الله، وجدد يقينك وتوكلك عليه."
]

MUHARRAM_MESSAGES = [
    "🌙 | تمر الأيام والسنوات كلمحة بصر، وها نحن نستقبل عاماً هجرياً جديداً. يسأل الإنسان نفسه أحياناً: كم بقي لي من العمر؟ وماذا أعددت لقبري وآخرتي؟ يا أخي، صحيفتك الماضية طويت، واليوم تُفتح لك صفحة جديدة. لا تبدأها بالغفلة، بل تبتل إلى الله وقل: 'يارب، إني تبت إليك فاهدني'. استقبل عامك بالاستغفار، عسى الله أن يبدل السيئات حسنات.",

    "📿 | نتحمس للعبادة والخير، نضع خططاً للالتزام بالصلاة وقراءة القرآن، ثم نضعف ويفتر الحماس ونعود للغفلة. هذا طبع البشر، والشيطان يتربص بنا، لكن المؤمن لا ييأس من روح الله. إن أردت الثبات هذا العام، فلا تكلف نفسك ما لا تطيق، بل الزم عبادة يسيرة وداوم عليها؛ ركعتين قبل النوم، أو وردٍ ثابت من الاستغفار. القليل الدائم يثبت قدمك على الصراط."
]

DHUL_HIJJAH_MESSAGES = [
    "🕋 | يا شباب، أقبلت الأيام العشر من ذي الحجة، وهي الأيام التي أقسم الله بها في القرآن لعظم قدرها. قد يرى أحدنا نفسه مقصراً في طاعته، أو غارقاً في ذنوبه فيظن أن هذه المواسم للصالحين فقط. هذا وهم؛ الله فتح باب التوبة للجميع. إن لم تستطع الصيام، فلا تترك الاستغفار. وإن قصرت في قيام الليل، فلا تفوت الصلوات المفروضة. أقبل على الله بضعفك، يأتيك برحمته وفضله.",

    "📿 | يمر الوقت وأنت تمسك بهاتفك، تتصفح المواقع والمقاطع، وتضيع الساعات دون فائدة. نحن الآن في أفضل أيام الدنيا، الأيام التي يحب الله فيها العمل الصالح أكثر من أي وقت آخر. اجعل لله نصيباً من يومك؛ استغفر وأنت تمشي، سبّح وأنت في طريقك إلى عملك أو دراستك. املأ صحيفتك بالحسنات، فلا تدري أي عمل يدخلك الجنة.",

    "🤲 | أحياناً يقف العبد للدعاء فيصمت، يخجل من كثرة تقصيره، أو يعجز لسانه عن ترتيب الكلام والدعاء البليغ. يا أخي، ارفع يديك إلى السماء وقل بلسان بسيط: 'يا رب، أنا العبد العاصي وأنت الغفور، أنا الضعيف وأنت القوي، فاغفر لي واهدني'. الله يعلم حاجتك ويسمع تضرعك الخفي. الحّ عليه بالدعاء في هذه الأيام المباركة، وسلْه حسن الخاتمة."
]
